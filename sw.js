// Dados oficiais atualizados até 25/09/2026; alteração deste arquivo força atualização do shell.
const CACHE = 'setembrox-v28-area-switch-fix';
const CORE = ['./index.html', './styles.css', './entry-v2.css', './arena-x.css', './ops-dashboard.css', './diagnostic.css', './fx.css', './layout-premium.css', './area-data.js', './fx-data.js', './app.js', './fx-engine.js', './sales-count-fix.js', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png', './icon-maskable-512.png'];
