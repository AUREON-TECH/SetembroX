const CACHE = 'setembrox-v8-shell-only';
const CORE = ['./index.html', './styles.css', './entry-v2.css', './app.js', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png', './icon-maskable-512.png'];
